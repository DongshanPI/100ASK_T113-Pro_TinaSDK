cmd_drivers/input/touchscreen/focaltech_touch/focaltech_test/src/focaltech_test_detail_threshold.o := arm-openwrt-linux-muslgnueabi-gcc -Wp,-MD,drivers/input/touchscreen/focaltech_touch/focaltech_test/src/.focaltech_test_detail_threshold.o.d  -nostdinc -isystem /home/ubuntu/tina-d1-h/prebuilt/gcc/linux-x86/arm/toolchain-sunxi-musl/toolchain/bin/../lib/gcc/arm-openwrt-linux-muslgnueabi/6.4.1/include -I./arch/arm/include -I./arch/arm/include/generated  -I./include -I./arch/arm/include/uapi -I./arch/arm/include/generated/uapi -I./include/uapi -I./include/generated/uapi -include ./include/linux/kconfig.h -include ./include/linux/compiler_types.h -D__KERNEL__ -mlittle-endian -Wall -Wundef -Werror=strict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -fshort-wchar -fno-PIE -Werror=implicit-function-declaration -Werror=implicit-int -Wno-format-security -std=gnu89 -fno-dwarf2-cfi-asm -fno-ipa-sra -mabi=aapcs-linux -mfpu=vfp -funwind-tables -marm -Wa,-mno-warn-deprecated -D__LINUX_ARM_ARCH__=7 -march=armv7-a -msoft-float -Uarm -fno-delete-null-pointer-checks -Wno-frame-address -Os --param=allow-store-data-races=0 -Wframe-larger-than=2048 -fstack-protector-strong -Wno-unused-but-set-variable -Wno-unused-const-variable -fomit-frame-pointer -fno-var-tracking-assignments -Wdeclaration-after-statement -Wvla -Wno-pointer-sign -Wno-array-bounds -Wno-maybe-uninitialized -fno-strict-overflow -fno-merge-all-constants -fmerge-constants -fno-stack-check -fconserve-stack -Werror=date-time -Werror=incompatible-pointer-types -Werror=designated-init    -DKBUILD_BASENAME='"focaltech_test_detail_threshold"' -DKBUILD_MODNAME='"focaltech_ts"' -c -o drivers/input/touchscreen/focaltech_touch/focaltech_test/src/focaltech_test_detail_threshold.o drivers/input/touchscreen/focaltech_touch/focaltech_test/src/focaltech_test_detail_threshold.c

source_drivers/input/touchscreen/focaltech_touch/focaltech_test/src/focaltech_test_detail_threshold.o := drivers/input/touchscreen/focaltech_touch/focaltech_test/src/focaltech_test_detail_threshold.c

deps_drivers/input/touchscreen/focaltech_touch/focaltech_test/src/focaltech_test_detail_threshold.o := \
  ...
  drivers/input/touchscreen/focaltech_touch/focaltech_test/src/../include/../../focaltech_common.h \
  drivers/input/touchscreen/focaltech_touch/focaltech_test/src/../include/../../focaltech_config.h \
  drivers/input/touchscreen/focaltech_touch/focaltech_test/src/../include/../../focaltech_flash.h \
  drivers/input/touchscreen/focaltech_touch/focaltech_test/src/../include/../../focaltech_flash/focaltech_upgrade_common.h \
  drivers/input/touchscreen/focaltech_touch/focaltech_test/src/../include/../../focaltech_flash/../focaltech_flash.h \
  drivers/input/touchscreen/focaltech_touch/focaltech_test/src/../include/focaltech_ic_table.h \

drivers/input/touchscreen/focaltech_touch/focaltech_test/src/focaltech_test_detail_threshold.o: $(deps_drivers/input/touchscreen/focaltech_touch/focaltech_test/src/focaltech_test_detail_threshold.o)
