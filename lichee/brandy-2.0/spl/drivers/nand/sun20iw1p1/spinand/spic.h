...
extern void Spic_set_master_slave(u32 spi_no, u32 master);
extern void Spic_sel_ss(u32 spi_no, u32 ssx);
extern void Spic_set_master_sample(u32 spi_no, u32 sample);
extern void Spic_set_rapids(u32 spi_no, u32 rapids);
extern void Spic_set_trans_mode(u32 spi_no, u32 mode);
extern void Spic_set_wait_clk(u32 spi_no, u32 swc, u32 wcc);
/*extern void spic_dma_onoff(u32 spi_no, u32 dma);*/
extern void Spic_config_dual_mode(u32 spi_no, u32 rxdual, u32 dbc, u32 stc);
extern void Spic_set_sample(u32 spi_no, u32 sample);
extern void Spic_set_sample_mode(u32 spi_no, u32 smod);
extern void Spic_set_trans_mode(u32 spi_no, u32 mode);

extern s32 Spic_init(u32 spi_no);
extern s32 Spic_exit(u32 spi_no);
extern s32 Spic_rw(u32 spi_no, u32 tcnt, u8 *txbuf, u32 rcnt, u8 *rxbuf, u32 dummy_cnt);

#define SPINAND_Print(fmt, args...)	printf(fmt, ##args)
