...
typedef struct {
	...
	__u8 BankCntPerChip; /*the count of the banks in one nand chip, multiple
	...
	__u8 SectorCntPerPage; /*the count of sectors in one single physic page,
				  one sector is 0.5k*/
	...
	__u32 BlkCntPerDie; /*the count of the physic blocks in one die, include
			       valid block and invalid block*/
	__u32 OperationOpt; /*the mask of the operation types which current nand
