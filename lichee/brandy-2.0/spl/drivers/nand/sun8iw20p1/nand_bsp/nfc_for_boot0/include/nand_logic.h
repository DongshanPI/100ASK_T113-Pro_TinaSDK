...
#define DATA_BLK_CNT_OF_ZONE                                                   \
	(NandDriverInfo.LogicalArchitecture->LogicBlkCntPerZone)
...
#define INTERLEAVE_BANK_CNT                                                    \
	(PAGE_CNT_OF_LOGIC_BLK /                                               \
	 NandDriverInfo.NandStorageInfo->PageCntPerPhyBlk)
...
#define NORMAL_MERGE_MODE                                                      \
	0x00 /*normal merge mode, there is not enough log item*/
#define SPECIAL_MERGE_MODE                                                     \
	0x01 /*special merge mode, there is not enough log page*/
...
************************************************************************************************************************
*/
__s32 LML_CalPhyPar(struct __PhysicOpPara_t *pPhyPar, __u32 nZone, __u32 nBlock,
		    __u32 nPage);
...
************************************************************************************************************************
*/
__s32 LML_BadBlkManage(struct __SuperPhyBlkType_t *pBadBlk, __u32 nZoneNum,
		       __u32 nErrPage, struct __SuperPhyBlkType_t *pNewBlk);
...
************************************************************************************************************************
*/
__s32 LML_CalculatePhyOpPar(struct __PhysicOpPara_t *pPhyPar, __u32 nZone,
