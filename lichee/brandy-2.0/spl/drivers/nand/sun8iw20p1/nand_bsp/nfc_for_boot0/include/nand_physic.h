...
#define SECTOR_CNT_OF_SUPER_PAGE                                               \
...
#define FULL_BITMAP_OF_SUPER_PAGE                                              \
	((__u32)((1 << (SECTOR_CNT_OF_SUPER_PAGE - 1)) |                       \
		 ((1 << (SECTOR_CNT_OF_SUPER_PAGE - 1)) - 1)))
...
#define SUPPORT_CACHE_PROGRAM                                                  \
	(NAND_CACHE_PROGRAM & NandStorageInfo.OperationOpt)
...
#define SUPPORT_MULTI_PROGRAM                                                  \
	(NAND_MULTI_PROGRAM & NandStorageInfo.OperationOpt)

/*define if the nand flash can support page copy-back with command operation*/
#define SUPPORT_PAGE_COPYBACK                                                  \
	(NAND_PAGE_COPYBACK & NandStorageInfo.OperationOpt)

/*define if the nand flash can support __s32ernal __s32er-leave operation*/
#define SUPPORT_INT_INTERLEAVE                                                 \
	(NAND_INT_INTERLEAVE & NandStorageInfo.OperationOpt)

/*define if the nand flash system can support external __s32er-leave operation*/
#define SUPPORT_EXT_INTERLEAVE                                                 \
	(NAND_EXT_INTERLEAVE & NandStorageInfo.OperationOpt)
...
#define SUPPORT_READ_UNIQUE_ID                                                 \
	(NAND_READ_UNIQUE_ID & NandStorageInfo.OperationOpt)

/*define if the nand flash system can support bank align*/
#define SUPPORT_ALIGN_NAND_BNK                                                 \
	(!(NAND_PAGE_ADR_NO_SKIP & NandStorageInfo.OperationOpt))
...
#define TOTAL_BANK_CNT                                                         \
	(NandStorageInfo.BankCntPerChip * NandStorageInfo.ChipCnt)
